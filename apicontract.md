...
Yêu cầu xóa phương tiện cá nhân. Yêu cầu này sẽ được đưa vào trạng thái `pending_delete` để Manager phê duyệt.
...
Từ chối xe kèm lý do. Hệ thống sẽ tự động khôi phục lại trạng thái cũ nếu là yêu cầu cập nhật hoặc xóa.
...
{
  "success": true,
  "message": "Đã từ chối và xóa đăng ký xe mới. | Đã từ chối bản cập nhật, khôi phục lại trạng thái xe cũ. | Đã từ chối yêu cầu xóa xe, khôi phục lại quyền hoạt động.",
  "data": {
    "vehicle_id": "uuid",
    "license_plate": "51A-12345"
  }
